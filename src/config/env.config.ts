...
export class ConfigService {
  ...
  private loadEnv() {
    ...
    if (process.env?.DOCKER_ENV === 'true') {
      ...
      this.env.SERVER.PORT = Number.parseInt(process.env.SERVER_PORT || process.env.PORT || '10000');
    }
  }
  ...
  private envProcess(): Env {
    return {
      SERVER: {
        ...
        PORT: Number.parseInt(process.env.SERVER_PORT || process.env.PORT || '10000'),
